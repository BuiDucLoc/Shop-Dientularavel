...
@section('trangchu')
	<div class="blog-post-area">
						...
						<div class="single-blog-post">
							...
							<p>
								Trong khi sức hút đến từ bộ ba iPhone 11 vẫn chưa nguội đi, hãng Apple vừa qua đã cho ra mắt "siêu phẩm" mới nhất 2020 mang tên IPHONE 12 . Với những nâng cấp đáng kể cho màn hình và hiệu năng, đây sẽ là smartphone thuộc phân khúc cao cấp đáng chú ý trong năm nay.</p>

							<h3>
								Màn hình Super Retina OLED rộng 6.1 inch, thân máy nguyên khối cứng cáp & bền bỉ.</h3> <br>
							...
							<a href="">
								<img src="{{ asset('public/frontend/image/iphone12.jpg') }}" alt="">
							</a>
							<p>
