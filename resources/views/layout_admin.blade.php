...
<!--logo start-->
<div class="brand">
    <a href="{{url('admin/dasboard')}}" class="logo">
        LOCKUPIN
    </a>
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu extended logout">
                ...
                <li><a href="{{url('admin/admin_dangxuat')}}"><i class="fa fa-key"></i> Đăng xuất</a></li>
            </ul>
        </li>
    ...
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                <li>
                    <a class="active" href="{{url('trangchu')}}">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{url('admin/order')}}">Quản lý đơn hàng</a></li>
                        {{-- <li><a href="{{url('admin/danhmucsanpham/them')}}">Thêm danh mục sản phẩm</a></li> --}}
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
                    ...
                    <ul class="sub">
                        <li><a href="{{url('admin/danhmucsanpham')}}">Danh mục sản phẩm</a></li>
                        <li><a href="{{url('admin/danhmucsanpham/them')}}">Thêm danh mục sản phẩm</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{url('admin/thuonghieu')}}">Thương hiệu sản phẩm</a></li>
                        <li><a href="{{url('admin/thuonghieu/them')}}">Thêm thương hiệu sản phẩm</a></li>
                    </ul>
                </li>
